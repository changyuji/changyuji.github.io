...
<html lang="en">
    <head>
        ...
        <link ref="stylesheet" type="text/css" href="vendor/css/ionicons.min.css">
        <link href="vendor/css/ionicons.css" type="text/css" rel="stylesheet">
        <link href="vendor/css/animate.css" type="text/css" rel="stylesheet">
        <link href="vendor/fonts/ionicons.eot" type="text/css" rel="stylesheet">
        <link href="vendor/fonts/ionicons.svg" type="text/css" rel="stylesheet">
    ...
    <body>
        ...
        <section class="section-steps">
            ...
            <div class="row">
                <div class="col span-1-of-2 step-box">
                    <img class="app-screen js--wp-2" src="/resources/img/app-iPhone.png" alt="a picture of the phone">
                </div>
                <div class="col span-1-of-2 step-box">
                    ...
                    <a class="btn-app" href="#"><img src="resources/img/download-app.svg" alt="download link picture for iphone"></a>
                    <a class="btn-app" href="#"><img src="resources/img/download-app-android.png" alt="download link picture for android"></a>
                </div>
            </div>
        </section>
        ...
        <section class="citys">
            ...
            <div class="row js--wp-3">
                <div class="col span-1-of-4 box">
                    ...
                    <img src="resources/img/lisbon-3.jpg" alt="lisbon pic">
                    <h3>lisbon</h3>
                ...
                <div class="col span-1-of-4 box">
                    ...
                    <img src="resources/img/san-francisco.jpg" alt="sanfransisco pic">
                    <h3>San Francisco</h3>
                    <div class="city-features">
                        <i class="ion-ios-person icon-small"></i>
                        3700+ happy eaters    
                ...
                <div class="col span-1-of-4 box">
                    ...
                    <img src="resources/img/berlin.jpg" alt="berlin pic">
                    <h3>berlin</h3>
                    <div class="city-features">
                        <i class="ion-ios-person icon-small"></i>
                        2300+ happy eaters    
                ...
                <div class="col span-1-of-4 box">
                    ...
                    <img src="resources/img/london.jpg" alt="london pic">
                    <h3>london</h3>
                    <div class="city-features">
                        <i class="ion-ios-person icon-small"></i>
                        1200+ happy eaters   
        ...
        <section class="plans js--section-plans">
            <div class="row">
         ...
         <div class="map-box"><!--<section class="form">-->
            <div class="map"></div>
            ...
            <div class="form-box" id="form">
                ...
                <div class="row">
                    ...
                    if($_GET('success') == -1) {
                        echo"<div class="form-message error">Error, please send again!</div>"}
                    ...
                    <form method="post" action="mailer.php" class="contact-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col span-2-of-3">
                                <select name="findusway" id="findusway">
        ...
        <footer>
            ...
            <div class="row">
                <p>Copyright &copy; 2015 by Ominifood. All right reserved.</p>
            </div>
        </footer>
